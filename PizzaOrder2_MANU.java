...
public class PizzaOrder {
     ...
     * @param numPizzas = positive int which sets the amount of pizzas for the order.
     */
    ...
    public void setNumPizzas(int numPizzas) {
        if (numPizzas >0){
            this.pizzaOrderArray = new Pizza[numPizzas];
    ...
    public void setPizza(int index, Pizza newPizza){
        this.pizzaOrderArray[index]= newPizza;
    }
    ...
    public Pizza getPizza(int index) {
        if (this.pizzaOrderArray.length > index - 1) {
            return this.pizzaOrderArray[index];
        } else {
            return nullPizza;
        }
    }
