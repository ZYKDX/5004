...
public class PizzaOrder
{
    ...
    /**
     * Getter for first pizza object in pizza order
     * @return orderPizza1 if it exists in the pizza order. returns null if no orderPizza1
     */
    ...
    /**
     * Setter for Pizza 1 in the order.
     * @param pizza = pizza object that will be set to pizza 1
     */
